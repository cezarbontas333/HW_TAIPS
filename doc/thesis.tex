...
\title{Modelarea deterministă şi extrapolarea seriilor de timp}					    % title of your manuscript
\author{Bontaș Cezar-Octavian, Dumitru Andrei, Cîrstocea Darius-Alexandru}																				% author name
\advisor{Dan Ștefănoiu}																			    % advisor name
